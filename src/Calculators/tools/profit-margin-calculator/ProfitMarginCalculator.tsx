              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">Pre-tax Profit</p>
                      <p className="text-2xl font-bold">${margins.pretaxProfit.toFixed(2)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">Pre-tax Margin</p>
                      <p className={`text-2xl font-bold ${getMarginStatus(margins.pretaxMargin)}`}>
                        {margins.pretaxMargin.toFixed(2)}%
                      </p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">Taxes</p>
                      <p className="text-2xl font-bold">${margins.taxes.toFixed(2)}</p>
                    </div>
                    <div>
