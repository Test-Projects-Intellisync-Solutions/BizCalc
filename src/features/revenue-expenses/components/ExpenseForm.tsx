...
export function ExpenseForm({ onUpdate, initialExpenses }: ExpenseFormProps) {
  ...
  const handleExpenseChange = useCallback(
    (index: number, field: keyof Expense, value: string | number) => {
              ...
              {expense.type === 'fixed' ? (
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleExpenseChange(index, 'variableRate', parseFloat(e.target.value) || 0)
                    }
                    placeholder="0.00"
                  />
                </div>
